console.log('Loading create vote event');
...
exports.handler = function(event, context) {
    ...
    if (!res.voteValue)
        context.succeed("missing voteValue");

    if (res.voteValue != -1 && res.voteValue != 1 && res.voteValue != 0)
        context.succeed("invalid voteValue");
